...
type SongRepository interface {
	...
	ListVisible(ctx context.Context, viewer uuid.UUID, limit, offset int) ([]models.Song, error)
	Update(ctx context.Context, id, owner uuid.UUID, patch SongPatch) error
	Delete(ctx context.Context, id, owner uuid.UUID) error
	SearchVisible(ctx context.Context, q string, viewer uuid.UUID, limit, offset int) ([]models.Song, error)
